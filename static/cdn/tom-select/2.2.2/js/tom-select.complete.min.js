...
let p,h
const g={},f={"/":"ā„ā•",0:"ß€",a:"ā±�ÉÉ‘",aa:"ź³",ae:"Ć¦Ē½Ē£",ao:"źµ",au:"ź·",av:"ź¹ź»",ay:"ź½",b:"Ę€É“Ę",c:"źæĘČ¼ā†„",d:"Ä‘É—É–į´…Ęź®·ŌÉ¦",e:"É›Ē¯į´‡É‡",f:"ź¯¼Ę’",g:"Ē�É ź˛�įµ¹ź¯æÉ¢",h:"Ä§ā±Øā±¶É�",i:"ÉØÄ±",j:"É‰Č·",k:"Ę™ā±Ŗź¯ź¯ź¯…ź˛£",l:"Å‚ĘÉ«ā±�ź¯‰ź¯‡ź˛É­",m:"É±ÉÆĻ»",n:"ź˛�Ę˛É²ź˛‘į´ˇŠ»Ō‰",o:"ĆøĒæÉ”Éµź¯‹ź¯¨į´‘",oe:"Å“",oi:"Ę£",oo:"ź¯¸",ou:"Č£",p:"Ę�įµ½ź¯‘ź¯“ź¯•Ļ",q:"ź¯—ź¯™É‹",r:"É¨É½ź¯›ź˛§ź˛",s:"ĆČæź˛©ź˛…Ź‚",t:"Å§Ę­Źā±¦ź˛‡",th:"Ć¾",tz:"ź©",u:"Ź‰",v:"Ź‹ź¯Ź",vy:"ź¯�",w:"ā±³",y:"Ę´É¸į»æ",z:"Ę¶Č�É€ā±¬ź¯£",hv:"Ę•"}
for(let e in f){let t=f[e]||""
for(let i=0;i<t.length;i++){let s=t.substring(i,i+1)
g[s]=e}}const v=new RegExp(Object.keys(g).join("|")+"|[Ģ€-ĶÆĀ·Ź¾Ź¼]","gu"),m=(e,t="NFKD")=>e.normalize(t),y=e=>c(e).reduce(((e,t)=>e+b(t)),""),b=e=>(e=m(e).toLowerCase().replace(v,(e=>g[e]||"")),m(e,"NFC"))
